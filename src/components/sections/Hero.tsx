  ...
  return (
    <section id="home" className="site-shell relative min-h-[880px] overflow-hidden pt-28 max-lg:pb-20 lg:pt-0">
      ...
      <Reveal className="relative z-10 px-[var(--page-pad)] pt-10 lg:absolute lg:left-0 lg:top-[142px] lg:w-[42%] lg:pt-0">
        <h1 className="display text-[clamp(3.35rem,5.22vw,6rem)] leading-[1.19] lg:whitespace-nowrap">Offrez-vous<br />un sourire beau,<br /><span className="text-brand">éclatant</span> et blanc.</h1>
      </Reveal>
      ...
      <div className="absolute right-[26px] top-[600px] z-20 hidden flex-col gap-4 lg:flex">
        <Link href="#home" aria-label="Revenir en haut" className="grid h-14 w-4 place-items-center"><Image src="/images/arrow-up.svg" alt="" width={56} height={8} className="max-w-none -rotate-90" /></Link>
        <Link href="#about" aria-label="Aller à la section suivante" className="grid h-14 w-4 place-items-center"><Image src="/images/arrow-down.svg" alt="" width={56} height={8} className="max-w-none rotate-90" /></Link>
      </div>
    </section>
  );
}
