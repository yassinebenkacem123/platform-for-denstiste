  ...
  return (
    <section id="home" className="site-shell relative overflow-hidden pb-16 pt-28 max-lg:min-h-0 lg:min-h-[880px] lg:pt-0">
      ...
      <Reveal className="relative z-10 px-[var(--page-pad)] pt-10 lg:absolute lg:left-0 lg:top-[142px] lg:w-[42%] lg:pt-0">
        <h1 className="display text-[clamp(2.6rem,5.22vw,6rem)] leading-[1.19] lg:whitespace-nowrap">Offrez-vous<br />un sourire beau,<br /><span className="text-brand">éclatant</span> et blanc.</h1>
      </Reveal>
