    ...
    <section id="map" aria-label="Notre emplacement" className="site-shell overflow-hidden">
      ...
      <Reveal className="flex flex-col items-center gap-4 bg-[#1e1e1e] px-[var(--page-pad)] py-8 text-center text-white sm:flex-row sm:justify-between sm:text-left">
        <div>
          ...
          <p className="mt-1 text-lg font-semibold tracking-[.03em]">DentaPro &mdash; 100 Rue de la Paix, Paris 75001</p>
        </div>
        <div className="flex flex-wrap justify-center gap-5 sm:justify-end">
          <a href="tel:0140001234" className="flex items-center gap-2 text-sm tracking-[.07em] text-muted transition hover:text-white">
          ...
          <a href="mailto:info@dentapro.fr" className="flex items-center gap-2 text-sm tracking-[.07em] text-muted transition hover:text-white">
          ...
          <a
            href="https://www.google.com/maps/dir/?api=1&destination=100+Rue+de+la+Paix+Paris+75001"
            target="_blank"
      ...
      <div className="relative h-[400px] w-full sm:h-[460px] lg:h-[500px]">
        <iframe
          title="Localisation de la clinique DentaPro"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2624.143697673422!2d2.329127076947!3d48.869198871327!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66e3b4498e80d%3A0x2daf9b1df7e4f4ab!2s100%20Rue%20de%20la%20Paix%2C%2075002%20Paris%2C%20France!5e0!3m2!1sfr!2sfr!4v1722895200000!5m2!1sfr!2sfr"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen
